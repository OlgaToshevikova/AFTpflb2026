...
public class Bankomat_1 {
    ...
    public Bankomat_1(int twenty, int fifty, int hundred) {
        this.twenty = twenty;
        this.fifty = fifty;
    ...
    public boolean withdrawMoney(int requiredSum) {
            ...
            if (tempRegHundred >= 1) {        //Нужны ли 100 купюры
                ...
                if (enoughHundred >= 0) {//Есть ли достаточное количество 100 купюр
                    ...
                    if (rest == 0) {
                        ...
                        System.out.println("Сумма выдана купюрами: сотни " + tempHundred + " штук");
                    ...
                    if (fifty >= addFiftyCount) {
                        ...
                        if (rest == 0) {
                            result = true;
                            System.out.println("---------------Итоговая информация---------------------------");
                            System.out.println("Сумма выдана купюрами с номиналом 100 единиц " + tempHundred + "штук, с номиналом 50 единиц " + tempFifty);
                        ...
                        if (twenty >= addTwentyCount) {
                            ...
                            System.out.println("---------------Итоговая информация---------------------------");
                            System.out.println("result равен " + result);
                            System.out.println("Сумма выдана купюрами с номиналом 100 единиц " + tempHundred + "штук, с номиналом 50 единиц " + tempFifty + " с номиналом 20 единиц " + tempTwenty);
                            return result;
                        } else {
                            result = false;
        ...
        } else if (rest / 50 == 1 && rest != 60 && rest != 80) {
